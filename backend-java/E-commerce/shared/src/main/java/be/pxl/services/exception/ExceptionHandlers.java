...
public class ExceptionHandlers {
    ...
    ResponseEntity<ErrorResponseBody> handleBadRequestExceptions(BadRequestException exception) {
        return new ResponseEntity<>(new ErrorResponseBody(exception.getMessage()), HttpStatus.BAD_REQUEST);
    }
